defmodule ThunderlineWeb do
  ...
  call separate modules and define the functions there.
  """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: ThunderlineWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ThunderlineWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: ThunderlineWeb.Endpoint,
        router: ThunderlineWeb.Router,
        statics: ThunderlineWeb.static_paths()
    end
  end
