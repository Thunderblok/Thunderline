defmodule Thunderline.Agents.Actions.AssessContext do
  ...
  - Current PAC Agent state and needs
  - Environmental factors and zone context
  - Relevant memories and past experiences
  - Available tools and capabilities
  - Social context and nearby PAC Agents
  - Federation context across supervisor nodes
  """
  ...
  use Jido.Action,
    ...
    schema: [
      ...
      federation_context: [type: :map, default: %{}]
    ]
  ...
  defp fallback_assessment(agent, zone_context, memories, tools, tick_count, federation_context) do
  ...
  defp generate_context_summary(ai_assessment, agent) do
    ...
    "#{agent.name} is feeling #{emotional_state}. Current priorities: #{priority_list}"
  end
  ...
  defp is_tool_applicable?(tool, traits, stats, state) do
    ...
    case tool do
      "communication" -> "social" in traits or stats["social"] > 50
      "analysis" -> "analytical" in traits or stats["intelligence"] > 60
      "creative" -> "creative" in traits or stats["creativity"] > 60
